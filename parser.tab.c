...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_while_stmt = 23,                /* while_stmt  */
...
{
       0,   104,   104,   114,   118,   126,   130,   134,   138,   146,
     161,   170,   179,   188,   197,   202,   210,   215
};
#endif
...
static const char *const yytname[] =
{
  ...
  "PRINT", "WHILE", "ASSIGN", "PLUS", "RELOP", "SEMICOLON", "LPAREN",
  "RPAREN", "LBRACE", "RBRACE", "$accept", "program", "statement_list",
  "statement", "declaration", "assignment", "print_stmt", "while_stmt",
  "condition", "expression", "term", YY_NULLPTR
};
...
{
       0,     3,    15,    -3,     7,    20,   -14,     0,   -14,   -14,
     -14,   -14,    10,    11,    10,    10,   -14,   -14,   -14,   -14,
       1,   -14,   -14,    -5,     8,     6,    10,   -14,    12,    13,
      10,   -14,   -14,     0,    16,     9,   -14
};
...
{
       0,     0,     0,     0,     0,     0,     2,     3,     5,     6,
       7,     8,     0,     0,     0,     0,     1,     4,    16,    17,
       0,    15,     9,     0,     0,     0,     0,    10,     0,     0,
       0,    14,    11,     0,    13,     0,    12
};
...
{
      17,    23,    25,     1,    26,     2,     3,     4,    28,    14,
      26,    12,    27,    18,    19,    26,    30,    34,    13,    15,
      16,    29,    22,    32,    36,    26,    35,    33,    31
};

static const yytype_int8 yycheck[] =
{
       7,    14,    15,     3,     9,     5,     6,     7,    13,    12,
       9,     8,    11,     3,     4,     9,    10,    30,     3,    12,
       0,    13,    11,    11,    15,     9,    33,    14,    26
};
...
{
       0,     3,     5,     6,     7,    17,    18,    19,    20,    21,
      22,    23,     8,     3,    12,    12,     0,    18,     3,     4,
      25,    26,    11,    25,    24,    25,     9,    11,    13,    13,
      10,    26,    11,    14,    25,    18,    15
};
...
#line 105 "parser.y"
    {
        (yyval.node) = create_program_node((yyvsp[0].node));
        ast_root = (yyval.node);  /* Store root for later processing */
...
#line 1196 "parser.tab.c"
  ...
  case 9: /* declaration: INT ID SEMICOLON  */
#line 147 "parser.y"
    {
        (yyval.node) = create_declaration_node((yyvsp[-1].str));
        printf("[PARSER] Declaration: int %s;\n", (yyvsp[-1].str));

        /* Add to symbol table during parsing for early error detection */
        if (global_symtab && !add_symbol(global_symtab, (yyvsp[-1].str), TYPE_INT, line_num)) {
            fprintf(stderr, "Semantic Error at line %d: Variable '%s' already declared\n",
                    line_num, (yyvsp[-1].str));
        }
    }
#line 1211 "parser.tab.c"
    break;

  case 10: /* assignment: ID ASSIGN expression SEMICOLON  */
#line 162 "parser.y"
    {
...
#line 1220 "parser.tab.c"
  ...
  case 11: /* print_stmt: PRINT LPAREN expression RPAREN SEMICOLON  */
#line 171 "parser.y"
    {
...
#line 1229 "parser.tab.c"
  ...
  case 12: /* while_stmt: WHILE LPAREN condition RPAREN LBRACE statement_list RBRACE  */
#line 180 "parser.y"
    {
...
#line 1238 "parser.tab.c"
  ...
  case 13: /* condition: expression RELOP expression  */
#line 189 "parser.y"
    {
        (yyval.node) = create_condition_node((yyvsp[-2].node), (yyvsp[-1].str), (yyvsp[0].node));
